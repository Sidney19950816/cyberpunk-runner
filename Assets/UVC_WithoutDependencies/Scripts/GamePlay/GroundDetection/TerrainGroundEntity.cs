...
#pragma warning disable 0649
        ...
        [SerializeField] List<TerrainGroundConfig> GroundConfigs = new();     //List of available configs.
...
#pragma warning restore 0649
        ...
        Dictionary<byte, GroundConfig> GroundConfigsDictionary = new();  //A dictionary created in Awake to find the desired texture.
        ...
        public override GroundConfig GetGroundConfig (Vector3 position)
        {
            ...
            var mapX = (int)((position.x - TerrainPos.x) / StepX);
            var mapZ = (int)((position.z - TerrainPos.z) / StepZ);
        ...
        public void CacheDominantTextures ()
        {
            ...
            for (var x = 0; x < width; x++)
            {
                ...
                {
                    var splatmapData = terrainData.GetAlphamaps(x, z, 1, 1 );
