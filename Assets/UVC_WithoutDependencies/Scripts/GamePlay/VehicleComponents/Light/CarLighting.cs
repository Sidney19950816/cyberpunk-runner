...
#pragma warning restore 0649
        ...
        List<LightObject> MainLights = new();
        List<LightObject> LeftTurnLights = new();
        List<LightObject> RightTurnLights = new();
        List<LightObject> BrakeLights = new();
        List<LightObject> ReverseLights = new();
        ...
        List<LightObject> ActiveTurns = new();
        ...
        private void Update ()
        {
            var carInBrake = Car != null && Car.CurrentBrake > 0;
