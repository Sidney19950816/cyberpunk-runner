...
#pragma warning disable 0649
        ...
        [SerializeField] List<CollissionParticles> CollisionParticlesList = new();
...
#pragma warning restore 0649
        ...
        Queue<TrailRenderer> FreeTrails = new(); //Free trail pool
        ...
        protected virtual void Update ()
        {
            ...
            var rndValue = UnityEngine.Random.Range(0, 1f);
        ...
        public void PlayCollisionParticles (VehicleController vehicle, Collision collision)
        {
            ...
            var dotProduct = Vector3.Dot(collision.relativeVelocity.normalized, collision.contacts[0].normal).Abs();
            var magnitude = collision.relativeVelocity.magnitude * dotProduct;
        ...
        {
            for (var i = 0; i < CollisionParticlesList.Count; i++)
            {
