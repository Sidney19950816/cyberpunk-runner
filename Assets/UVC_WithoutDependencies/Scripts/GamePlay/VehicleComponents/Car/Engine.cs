...
namespace PG
{
    ...
    public partial class CarController :VehicleController
    {
        ...
        public float MinRPM => Engine.MinRPM;
        ...
        public bool InHandBrake => CarControl != null && CarControl.HandBrake && !BlockControl;
        ...
        public float EngineHealth => EngineDamageableObject ? EngineDamageableObject.HealthPercent : 1;
        ...
        void FixedUpdateEngine ()
        {
            ...
            {
                var rpmToCutOffNormolize = (EngineRPM / Engine.CutOffRPM).Clamp ();
                var targetTurbo = InChangeGear || CurrentAcceleration < 0.2f? 0: rpmToCutOffNormolize;
