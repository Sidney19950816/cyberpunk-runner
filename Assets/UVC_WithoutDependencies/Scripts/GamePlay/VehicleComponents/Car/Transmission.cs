...
namespace PG
{
    ...
    public partial class CarController :VehicleController
    {
        ...
        public int CurrentGearIndex => CurrentGear + 1; //Current gear index, starting at 0 for reverse gear: 0 - reverse, 1 - neutral, 2 - 1st gear, etc.
        public bool InChangeGear => ChangeGearTimer > 0;
        ...
        void AwakeTransmition ()
        {
            ...
            AllGearsRatio[1] = 0;
            for (var i = 0; i < Gearbox.GearsRatio.Length; i++)
            {
