...
#pragma warning disable 0649
        ...
        [SerializeField] List<CameraPreset> CameraPresets = new();
...
#pragma warning restore 0649
        ...
        bool СameraWasRotatedManually => TimerAfterMouseMove > 0;
        ...
        private IEnumerator Start ()
        {
            ...
            if (MobileUI.Instance)
            {
                MobileUI.Instance.ChangeViewButton.onClick.AddListener (SetNextCamera);
            }
        ...
        private void LateUpdate ()
        {
            if (ActivePreset.EnableRotation)
            {
                ...
                var needRotate = Car.RB.velocity.ZeroHeight().sqrMagnitude > 0.1f;
            ...
            var speedFactor = (Car.CurrentSpeed / 100).Clamp();
...
/*            if (GameController.SplitScreen)
        ...
        private void OnDestroy ()
        {
            ...
            if (MobileUI.Instance)
            {
                MobileUI.Instance.ChangeViewButton.onClick.RemoveListener (SetNextCamera);
            }
        ...
        void UpdateEffects ()
        {
            ...
            {
                var shakePower = ((Car.CurrentSpeed - ActivePreset.MinSpeedForStartShake) / (ActivePreset.MaxSpeedForMaxShake - ActivePreset.MinSpeedForStartShake)).Clamp();
        ...
        {
            var camTR = CameraViewTransform;
            var carSize = Car.Size;
            if (Car.ConnectedTrailer)
            {
                carSize += Car.ConnectedTrailer.Size;
            }
            ...
            var camPos = camTR.localPosition;
            var camRot = camTR.localRotation;
