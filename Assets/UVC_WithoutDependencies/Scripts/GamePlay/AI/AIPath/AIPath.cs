...
#pragma warning disable 0649
        ...
        public static List<AIPath> AIPaths = new();
...
#pragma warning restore 0649
        ...
        public Transform GetLastPoint => Waypoints[Waypoints.Count - 1].Point;
        ...
        public RoutePoint GetRoutePoint (float dist)
        {
            ...
            var p1 = GetRoutePosition (dist, out overtakeZoneLeft, out overtakeZoneRight, out speedLimit);
            var p2 = GetRoutePosition (dist + 0.1f, out temp1, out temp1, out temp1);
            var delta = p2 - p1;
        ...
        public struct WaypointData
        {
            ...
            public Vector3 localPosition => Point? Point.localPosition : Vector3.zero;
