...
namespace PG
{
    ...
    public class PursuitAIControl :BaseAIControl
    {
        ...
        LayerMask ObstacleHitMask => PursuitAIConfig.ObstacleHitMask;
        float HitPointHeight => PursuitAIConfig.HitPointHeight;
        float VisibilityArea => PursuitAIConfig.VisibilityArea;
        float VisibilityAreaIgnoreObstacle => PursuitAIConfig.VisibilityAreaIgnoreObstacle;
        float HitDellayTime => PursuitAIConfig.HitDellayTime;
