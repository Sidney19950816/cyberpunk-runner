...
namespace PG 
{
    ...
    public class BaseAIControl :MonoBehaviour, ICarControl
    {
        ...
        protected float ReverceWaitTime => BaseAIConfig.ReverceWaitTime;
        protected float ReverceTime => BaseAIConfig.ReverceTime;
        protected float BetweenReverceTimeForReset => BaseAIConfig.BetweenReverceTimeForReset;
