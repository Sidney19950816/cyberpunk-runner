...
namespace PG
{
    ...
    public class DriftAIControl :PositioningAIControl
    {
        ...
        float ObstacleHitDistance => DriftAIConfig.ObstacleHitDistance;
        float HitPointHeight => DriftAIConfig.HitPointHeight;
        LayerMask ObstacleHitMask => DriftAIConfig.ObstacleHitMask;
        float HitDellayTime => DriftAIConfig.HitDellayTime;
        ...
        private void ForwardMove ()
        {
            ...
            if (AheadRB)
            {
                ...
                var aheadRBSpeed = AheadRB.velocity.magnitude;
