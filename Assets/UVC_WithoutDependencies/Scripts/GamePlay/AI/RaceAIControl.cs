...
namespace PG
{
    ...
    public class RaceAIControl :PositioningAIControl
    {
        ...
        float Aggressiveness => RaceAIConfig.Aggressiveness;
        float ObstacleHitDistance => RaceAIConfig.ObstacleHitDistance;
        float HitPointHeight => RaceAIConfig.HitPointHeight;
        LayerMask ObstacleHitMask => RaceAIConfig.ObstacleHitMask;
        float ChangeHorizontalOffsetSpeed => RaceAIConfig.ChangeHorizontalOffsetSpeed;
        float OffsetForMainHitPoints => RaceAIConfig.OffsetForMainHitPoints;
        float OffsetForMainHitDirections => RaceAIConfig.OffsetForMainHitDirections;
        float OffsetForAdditionalHitPoints => RaceAIConfig.OffsetForAdditionalHitPoints;
        float MainHitDellayTime => RaceAIConfig.MainHitDellayTime;
        float AdditionalHitDellayTime => RaceAIConfig.AdditionalHitDellayTime;
        ...
        private void ForwardMove ()
        {
            ...
            var desiredSpeed = (1 - (angleToPredictionPoint / LookAngleSppedFactor)).AbsClamp ();
            ...
            if (AheadRB)
            {
                ...
                var aheadRBSpeed = Mathf.Lerp(AheadRB.velocity.magnitude, desiredSpeed, Aggressiveness);
            ...
            var targetOffset = CurrentHorizontalOffset;
        ...
        void UpdateAdditionalHits ()
        {
            ...
            for (var i = 0; i < AdditionalHits.Length; i++)
            {
