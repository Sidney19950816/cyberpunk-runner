...
{
    public class DailyRewardsEventManager : BaseBehaviour
    {
        ...
        public bool UpdateRewardsStatus(DailyRewardsView sceneView)
        {
            var time = Time.time;
        ...
        public async Task ClaimDailyReward()
        {
            try
            {
                ...
                Events.DailyReward dailyReward = (Events.DailyReward)claimResult.daysClaimed;
                await EventsService.UserDailyRewardsAsync(dailyReward);
